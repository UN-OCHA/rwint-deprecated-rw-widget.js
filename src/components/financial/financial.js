...
FinancialWidget.prototype.link = function(elements) {
  ...
  function chartInit() {
    ...
    function addClusterOverlay(node) {
      ...
      // @TODO: Get the icons as separate SVGS, render this as a div instead of as part of the svg.
      ...
      var iconx = (w / 2) - ((w > h) ? 430 : 460);
      var icony = (h / 2) - 200;
      overlay.append("path")
        .classed("detail--icon", true)
        .attr("transform", "scale(0.9) translate("+ iconx + "," + icony + ")")
        .attr("d", icon);

      overlay.select('.detail--icon').attr("transform", "scale(0.9) translate(" + iconx + "," + icony + ")");
    ...
    function getClusterIcon(original) {
      ...
      var icons = {
        ...
        "multicluster": "M497.1,144.9c0,7.6-6.1,13.7-13.5,13.7s-13.6-6.1-13.6-13.7s6.1-13.7,13.5-13.7S497.1,137.3,497.1,144.9 M483.5,181.2c-7.4,0-13.5,6.1-13.5,13.7s6.1,13.7,13.5,13.7s13.6-6.1,13.6-13.7C497.1,187.3,491,181.2,483.5,181.2 M532.9,181.2 c-7.5,0-13.5,6.1-13.5,13.7s6.1,13.7,13.5,13.7c7.5,0,13.5-6.1,13.5-13.7S540.4,181.2,532.9,181.2 M532.9,131.2 c-7.5,0-13.5,6.2-13.5,13.7c0,7.6,6.1,13.7,13.5,13.7c7.5,0,13.5-6.1,13.5-13.7C546.5,137.3,540.4,131.2,532.9,131.2 M508.2,156.2c-7.5,0-13.5,6.1-13.5,13.7s6.1,13.7,13.5,13.7c7.4,0,13.6-6.1,13.6-13.7S515.7,156.2,508.2,156.2"
      };
