...
templates['financial.hbs'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  return buffer + "  </div>\n  <div class=\"financial-widget--time\">\n    <h1>"
    ...
    + "\" target=\"_top\">Explore Funding Documents via ReliefWeb</a></footer>\n  <footer class=\"financial-widget--sources\">Data Source <cite><a href=\"\" target=\"_top\">Financial Tracking Service</a></cite></footer>\n</div>";
},"useData":true});
})();